...
Acesta este un proiect preluat de pe youtube si adaptat. In fisierul App.tsx se afla codul pentru aplicatia Android.
Codul pentru Arduino se afla in folderul src din folderul Arduino. 
#
#
